...
<a href="admin.html" style="color: #000000;"><i class="material-icons" style="font-size:30px">arrow_back</i></a>
    <div data-include="test.html"></div>
    <div class="mx-auto text-center m">
        <p style="font-weight:lighter;font-size: 40px;">Enter Number of Denominations</p>
    </div>
    <div class="mx-auto text-center">
        <!-- Code to input denomination notes for admin -->
...
//   Inserting denominations notes to DB
